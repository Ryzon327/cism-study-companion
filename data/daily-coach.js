  ...
  window.CISMDailyCoach = {
    definitions: {
      ...
      "2": [
        ...
        {term:"Asset Value (AV)", plain:"The value assigned to the asset being analyzed.", clue:"What is the asset worth?", contrast:"AV is the starting value, not the expected loss.", memory:"AV = what the asset is worth."},
        {term:"Exposure Factor (EF)", plain:"The percentage of asset value expected to be lost from one event.", clue:"Percent lost in one occurrence", contrast:"EF is a percentage; SLE is the resulting money loss.", memory:"EF = how much of the asset one event takes."},
        {term:"Single Loss Expectancy (SLE)", plain:"The expected monetary loss from one occurrence.", clue:"Loss from one event", contrast:"ALE is expected yearly loss.", memory:"AV × EF = SLE."},
        {term:"Annualized Rate of Occurrence (ARO)", plain:"The expected frequency of an event during one year.", clue:"How often per year?", contrast:"ARO is frequency, not money.", memory:"ARO = expected yearly frequency."},
        {term:"Annualized Loss Expectancy (ALE)", plain:"The expected monetary loss from a risk over one year.", clue:"Expected yearly loss", contrast:"SLE is one event; ALE includes annual frequency.", memory:"SLE × ARO = ALE."}
      ],
      "3": [
    ...
    lifecycleExercises: {
      ...
      "2": [
        ...
        {title:"Quantitative risk — one event", scenario:"An information asset is valued at $200,000. One occurrence is expected to destroy 25% of its value. What is the SLE?", options:["$12,500","$50,000","$150,000","$200,000"], correctIndex:1, why:"SLE is one-event loss: AV × EF = $200,000 × 0.25 = $50,000."},
        {title:"Quantitative risk — annual loss", scenario:"A risk has an SLE of $50,000 and is expected once every four years. What is the ALE?", options:["$12,500","$50,000","$200,000","$250,000"], correctIndex:0, why:"Once every four years means ARO = 0.25. ALE = SLE × ARO = $12,500 per year."},
        {title:"Quantitative risk — business meaning", scenario:"A safeguard costs $40,000 per year while untreated ALE is $12,500. What should these figures do?", options:["Automatically force implementation","Inform cost-benefit and risk treatment decisions","Automatically force acceptance","Let security accept the risk alone"], correctIndex:1, why:"Quantitative values inform management judgment; they do not automatically dictate treatment."}
      ],
      "3": [
