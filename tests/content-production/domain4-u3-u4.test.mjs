...
test("batch boundary: D4-U1/U2/U3/U4 lessons exist, and no Domain 5 exists", () => {
  // Originally asserted D4-U1 through U4 were the ONLY Domain 4 lessons in
  // existence. D4-U5/U6 have since been authored (see
  // tests/content-production/domain4-u5-u6.test.mjs), so this test is
  // narrowed to confirm U1-U4 still exist rather than that nothing beyond
