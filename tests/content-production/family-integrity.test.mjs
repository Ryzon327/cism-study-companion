...
test("every family has exactly its expected active variant count (Phase 6C + Phase 7B-1)", () => {
  ...
  const expected = {
    ...
    "family.d3.program-foundations": 3,
    "family.d3.asset-classification": 3,
    "family.d3.policy-governance": 3,
    "family.d3.control-design-selection": 3,
    "family.d3.control-implementation-integration": 3,
    "family.d3.control-testing-evaluation": 3,
    "family.d3.awareness-training": 3,
    "family.d3.external-services": 3,
    "family.d3.program-metrics-reporting": 3,
    "family.d3.program-synthesis": 3,
    "family.d4.program-foundations-readiness": 3,
    "family.d4.business-impact-analysis-prioritization": 3,
    ...
    "family.d4.post-incident-review": 3,
