...
import { listPracticeScopes, getPracticeCountOptions, buildPracticeSession, conceptForQuestion, ALL_SCOPE_ID } from "../content/practice";
 ...
 */
export function PracticeScreen({ onExit, onExploreConcept }: PracticeScreenProps): JSX.Element | null {
  ...
  const countOptions = getPracticeCountOptions(scopeId);
  ...
  function startPractice() {
    ...
    const questions = buildPracticeSession(scopeId, effectiveCount);
